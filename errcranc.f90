...
implicit none(type, external)
    ...
    real, parameter :: Az =1.0/(N), Tc = 36.5, cv = 3686, r = 1081, k=0.56, s=0.472, v=40,  L=0.02, A_z=0.5
    ...
    open(unit=13, file="cranc_error05.txt", status="replace")   
    do w = 0, N
