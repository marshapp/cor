program explicit
    ...
    real(KIND=DP) :: dz, dt, alpha, lambda, P_ext, beta, gamma(3), R(0:N_z-1,3)
    real(KIND=DP), parameter :: L = 0.02, V = 40, c_v = 3686, rho = 1081, k = 0.56, sigma = 0.472, T_c=36.5, t_a=0.025
